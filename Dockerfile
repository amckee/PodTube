...
LABEL net.ftawesome.home.version='2025.09.24.4'
...
# RUN pip install git+https://github.com/JuanBindez/pytubefix.git@tree/sig-nsig # For quick fixes when Youtube changes
