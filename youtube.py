...
def get_youtube_url(video):
    ...
    try:
        ## Attempted fix as per https://github.com/pytube/pytube/issues/2062#issuecomment-2452418787
        # import ssl
        # import re
        # import pytubefix
        ...
        # _default_clients["IOS"]["innertube_context"]["context"]["client"]["clientVersion"] = "19.08.35"
        # # _default_clients["ANDROID_EMBED"]["innertube_context"]["context"]["client"]["clientVersion"] = "19.08.35"
        # # _default_clients["IOS_EMBED"]["innertube_context"]["context"]["client"]["clientVersion"] = "19.08.35"
        # _default_clients["IOS_MUSIC"]["innertube_context"]["context"]["client"]["clientVersion"] = "6.41"
